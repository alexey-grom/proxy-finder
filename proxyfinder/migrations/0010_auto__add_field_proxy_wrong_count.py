...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Proxy.wrong_count'
        db.add_column(u'proxyfinder_proxy', 'wrong_count',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Proxy.wrong_count'
        db.delete_column(u'proxyfinder_proxy', 'wrong_count')
